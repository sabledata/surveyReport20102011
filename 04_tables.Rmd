...
```
\clearpage
(ref:table9Caption) Summary of sablefish biological data collected at the  `r yr` StRS sites.
...
(ref:table11Caption) Summary of sablefish biological data collected at the  `r yr` inlet sites.
...
\ \
\ \
(ref:table12Caption) Summary of sablefish biological data collected at the `r yr+1` StRS sites.
\ \
\ \
...
```{r Table13, echo=FALSE}
    ...
    bio.summary.inlet2   <-  read.csv(paste(path,'Table12.csv',sep=''), header=T)
