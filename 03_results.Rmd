...
In general, catch per unit effort as indexed by kilograms (Figure \@ref(fig:figure7)) and numbers of sablefish  (Figure \@ref(fig:figure8)) per trap, attained the highest catch rates in the middle depth stratum (RD~2~) in most years. The average weight of sablefish over time in the deep (RD~3~)  and shallow waters (RD~1~) tended to be higher in the northern survey areas. In the middle depths (RD~2~), the mean weights were consistently higher in area S~4~ (Figure \@ref(fig:figure9)).  CPUE over the survey years (2003 to 2011) reached over 30 kg/trap and over 11 fish/trap in 2003 and 2006 (Figure \@ref(fig:figure10),a,b), while the average weight of sablefish remained ~ 3 kg  (Figure \@ref(fig:figure10),c).

### Offshore Standardized CPUE

Standardized sets were conducted at offshore indexing sites from 1988 through 2010. The 1988 and 1989 standardized catch rates were not included in Figure \@ref(fig:figure7) as the fishing protocols were significantly different than future surveys [@Wyeth2003].  The mean catch rates remained high from 1990 through 1993, with the year 1993 yielding the highest mean catch rate. Then, consistent lower catch rates were exhibited from 1994 to 2002, with the year 2001 yielding the lowest mean catch rate. In 2003 and 2004, the mean catch rates were again higher and similar to those in the first couple years in the 1990’s.  The years 2005 through 2010 show consistently lower catch rates that resemble those in the late 1990’s (Figure \@ref(fig:figure11),a,b).  The mean sablefish weight remained over 3.0 kg for years 1990 - 2010 with the exception of 1990, 2006 and 2007 (Figure \@ref(fig:figure11),c).

### Mainland Inlet CPUE

CPUE in the mainlaind inlets has varied in a relatively predictable manner over time with peak CPUE occuring every 5-7 years. In the early part of the time series (mid-1990s) average CPUE remained relatively constant before a peak in CPUE was observed in 1999, followed by declines to consistent levels until another peak in 2003 and 2004, and again in 2011 (Figure \@ref(fig:figure12) a,b). The average weight of sablefish was lowest at mainland inlets during these peaks (Figure \@ref(fig:figure12) c).
...
Overall, the StRS design sets had a higher proportion of females than males over `r stratafemale.2`.  More females than males were seen in the shallow depth stratum within `r shallsfemale.2`.  In the mid depth stratum, there were more males than females in `r midsmale.2`.  The deepest depth stratum saw more females `r deepsfemale.2`.  The mean fork length for females reached 69 cm in area S~4~ (Table \@ref(tab:Table13)).

More females than males were sampled in `r inlet.words.yr2` traditional mainland inlet localities and samples ranged from `r femaleRange.yr2[1]` to `r femaleRange.yr2[2]` percent females.  The mean fork length for females was `r round(biosumm.Inlet.yr2[5,6]/10,0)` cm (Table \@ref(tab:Table12)).
...
During the `r yr` and `r yr+1` sablefish surveys, `r count.sample.yr1[2,3] + count.sample.yr1[1,3]` and `r count.sample.yr2[2,3] + count.sample.yr2[1,3]` previously tagged fish were re-released live with a new tag, respectively.  DFO has been tagging, releasing and recovering sablefish since 1991.  The highest recovery rate is within the first year of release (Table \@ref(tab:Table14)).
