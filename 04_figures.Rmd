...
(ref:figure1) Location of the boundaries of the mainland inlet localities, offshore indexing localities (2010), exploratory sites (2011) and the five spatial areas (S~1~-S~5~) of the stratified random survey design. The three depths strata (RD~1~-RD~3~) are colour-coded and nested within each of the five spatial strata. 

```{r figure1, fig.cap='(ref:figure1)', warning=FALSE, echo=FALSE, dpi=550, out.width = "430px", out.height = "510px", fig.align="center"}
      img <- paste(figpath,'Figure1.png',sep="") 
      knitr::include_graphics(img)
```
\clearpage

(ref:figure2)  Start locations of the `r yr` standardized sets (yellow markers) conducted at offshore indexing localities and StRS sets (red markers) conducted in spatial stratum areas S~1~ through S~5~.
...
(ref:figure3)  Start locations of the `r yr+1` exploratory sets (purple markers) and StRS sets (red markers) conducted in spatial stratum areas S~1~ through S~5~.
...
```{r figure4, fig.cap='(ref:figure4)', out.width = "450px", out.height = "570px", echo=FALSE, fig.align="center", warning=FALSE}
...
(ref:figure7defunct) Sablefish catch per unit effort (CPUE) by depth and year for StRS sets. Dashed lines delineate depth strata (shallow(RD~1~) = 100-450m, mid(RD~2~) = 450-850m, deep(RD~3~) = 850-1400m).
